...
<?php include 'menu.php'; ?>
  ...
  <h1>Restaurant Feature</h1>
  <p>Live Your Dream With Us  :)</p>
</div>


  <section class="my-5">
    <div class="py-5">
      <h1 class="px-5 display-4">
       Login Successfully :)
      </h1>
    </div>
